...
We use **[Dove](https://github.com/pontem-network/move-tools/tree/1.2.8) build system** (tag: `1.2.8`) for building, package management, dependencies, and testing. After successful Dove installation, you can just run:
`dove build`
